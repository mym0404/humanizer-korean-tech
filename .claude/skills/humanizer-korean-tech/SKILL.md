...
# Humanizer Korean Tech — AI 한글 티 제거 오케스트레이터 (v1.5)
...
```
humanizer-korean-tech v1.5 — {fast|strict} 모드 / run_id: {YYYY-MM-DD-NNN}
```
...
1. 플러그인 설치 시 — `humanizer-korean-tech` 플러그인이 `agents/`를 번들로 제공(전역).
